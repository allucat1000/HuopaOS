...
async function mainScreen() {
    ...
    await huopaAPI.setAttribute(customizationTab, "style", "display: block; background-color: rgba(45, 45, 45, 0.5); border-style: solid; border-color: rgba(105, 105, 105, 0.6); border-radius: 0.5em; color: white; margin: 0.5em auto; padding: 1.25em; width: 65%; cursor: pointer;");
...
async function customizationTabLoad() {
    ...
    await huopaAPI.setAttribute(backButton, "style", "display: block; background-color: rgba(45, 45, 45, 0.5); border-style: solid; border-color: rgba(105, 105, 105, 0.6); border-radius: 0.5em; color: white; padding: 0.5em; cursor: pointer; position: fixed; bottom: 0.5em; left: 0.5em;");
    ...
    for (const wallpaperPath of wallpaperList) {
        ...
        await huopaAPI.setAttribute(wallpaperButton, "style", "border-radius: 0.5em; padding: 0; width: 25%; aspect-ratio: 16 / 9; background-color: rgba(0, 0, 0, 0); margin: 1em; cursor: pointer; overflow: hidden; border: solid 2px white; min-width: 200px; flex: 1 0 100px; max-width: 200px;");
    ...
    await huopaAPI.setAttribute(importButton, "style", "border-radius: 0.5em; padding: 0; width: 25%; background-color: rgba(105, 105, 105, 0.3); margin: 1em; cursor: pointer; overflow: hidden; border: solid 2px white; min-width: 200px; flex: 1 0 100px; max-width: 200px; color: white; aspect-ratio: 16 / 9;");
