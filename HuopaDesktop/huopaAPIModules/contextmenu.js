...
return {
    set: async(el, options) => {
        el.addEventListener("contextmenu", (e) => {
            ...
            contextMenu.style = "background-color: rgba(55, 55, 55, 0.65); border-radius: 0.5em; border: rgba(105, 105, 105, 0.65) 1px solid; position: absolute; z-index: 9999; box-shadow: 2px 2px 10px rgba(0,0,0,0.1); display: block; padding: 0;";
